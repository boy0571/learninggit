...
'''
inputpath='~/Documents/pankoo_package/ready_data_NOPATA_0531.csv'
data=pd.read_csv(inputpath,index_col=False)
...
for i in range(1,len(data_shop)-28):
    ...
    data_shop.loc[i,'Spring_Eve_In']=data_shop.loc[i+1:i+28,'Spring_Eve'].max()
...
outputpath='~/Documents/pankoo_package/ready_data_NOPATA_month_0531.csv'
